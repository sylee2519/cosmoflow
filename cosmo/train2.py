...
def append_to_json_file(data, filename='/lustre/orion/proj-shared/stf008/hvac/sylee/cosmoflow/training_configurations.json'):
...
def parse_args():
    ...
    add_arg('config', nargs='?', default='/lustre/orion/proj-shared/stf008/hvac/sylee/cosmoflow/configs/cosmo.yaml')
